...
### Заголовки (строка 5)
**Строка 5** содержит названия столбцов (заголовки таблицы)

### Данные (строки 6+)
С **строки 6** и далее начинаются фактические данные для объединения
...
config := &core.SheetConfig{
    SheetName: "Sheet1",  // или фактическое имя листа
    HeaderRow: 5,          // Заголовки в 5-й строке
    Enabled:   true,
...
1. **Header Row = 5** - не забудьте указывать правильный номер строки
